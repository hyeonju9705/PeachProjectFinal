          ...
          <div class="form-content">
            <form method="post">
              <div class="form-group">
                ...
                <input type="text" id="userid" name="id" required="required">
              </div>
              <div class="form-group">
                <label for="password">Password</label>
                <input type="password" id="userid" name="password" required="required">
              </div>
                <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="adress" name="addr" required="required">
              </div>  
               <div class="form-group">
